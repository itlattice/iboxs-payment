...
class WxPayConfig extends WxPayConfigInterface
{
	...
	**/
	...
	{
		if(isset($this->config['merchantid'])){
			return env("web.host")."/user/userpay/wxnotify";
		}
		return env("web.host")."/user/pay/wxnotify";
	}
