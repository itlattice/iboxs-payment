本项目正在开发2.0版本，将比1.0系列版本更实用也更便于调用（当前位于dev_2.0分支）,版本不兼容，若有兴趣一起测试2.0版本的，可是要dev_2.0分支代码进行开发，有建议的请提issue。
### 项目来历
...
### 请注意
* 本项目所用微信支付接口为旧版本，最新的微信支付V3接口正在dev_wxv3分支中开发和测试中；
* 本项目开源许可为MIT许可，但禁止用于赌毒及政府项目，本项目源码全部开源，作者不承担因本项目漏洞或其他不足所带来的任何损失，请自行甄别和选用。
* 本项目所用PHP版本建议使用7.1及以上版本；
