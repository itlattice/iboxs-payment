<?php
/**
 * 这里是微信支付付款码支付（V2）demo
 * 文档地址：https://pay.weixin.qq.com/doc/v2/merchant/4011936234
 */
...
$total_fee=1;   //订单金额，单位元（注意这里，也是传入元为单位，与支付宝一致，组件内会根据情况处理）
$body="订单测试";  //商品描述
$auth_code='123456789'; //付款码
...
try{
    ...
    $payment=$payment->wechatBarcodePay($out_trade_no,$total_fee,$body,$auth_code);
