...
try{
    ...
    $html= Payment::setConfig($config);//laravel/thinkphp框架下按文档说明把配置文件放入config文件夹下后，无需调用本函数，可直接使用Payment::wechatOutTradeQuery()
    $html=$html->wechatOutTradeQuery($out_trade_no);
