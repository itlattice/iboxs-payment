...
/**
 * 这里是微信支付H5支付demo
 * 文档地址：https://pay.weixin.qq.com/doc/v3/merchant/4012791834
 */
...
try{
    ...
    $payment= Payment::setConfig($config);//laravel/thinkphp框架下按文档说明把配置文件放入config文件夹下后，无需调用本函数，可直接使用Payment::wechatH5Pay()
    $payment=$payment->wechatH5Pay($out_trade_no,$amount,$description,$scene_info);
