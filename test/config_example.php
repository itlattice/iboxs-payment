...
return [
    ...
    'wechat'=>[
        ...
        'mchid'=>'',  //商户号
        'appid'=>[  //需要先与商户号进行绑定（）
            'app'=> 'wx8888888888888888', //【APP支付用，无就不设置即可】应用APPID(商户在微信开放平台(移动应用)
            'mp'=>'wx9999999999999999', //【公众号支付用，调用JS支付接口】公众号APPID
            'mini'=>'wx7777777777777777', //【小程序支付用，调用小程序支付接口】小程序APPID
        ],
