<?php
/**
 * 这里是支付宝统一收单交易撤销接口demo
 * 文档地址：https://opendocs.alipay.com/open/13399511_alipay.trade.cancel
 */
...
try{
    ...
    $payment= Payment::setConfig($config);  //laravel/thinkphp框架下按文档说明把配置文件放入config文件夹下后，无需调用本函数，可直接使用Payment::alipayTradeCancel()
    $payment=$payment->alipayTradeCancel($out_trade_no,$trade_no);
