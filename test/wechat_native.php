<?php
/**
 * 这里是微信支付Native支付demo(二维码扫码支付)
 * 文档地址：https://pay.weixin.qq.com/doc/v3/merchant/4012791877
 */
...
try{
    ...
    $payment= Payment::setConfig($config);//laravel/thinkphp框架下按文档说明把配置文件放入config文件夹下后，无需调用本函数，可直接使用Payment::wechatNativePay()
    $payment=$payment->wechatNativePay($out_trade_no,$amount,$description);
