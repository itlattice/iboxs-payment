<?php
/**
 * 这里是支付宝统一收单线下交易预创建demo【就是俗称的二维码支付，接口生成二维码，用户使用扫一扫扫码支付】
 * 文档地址：https://opendocs.alipay.com/open/8ad49e4a_alipay.trade.precreate
 */
...
try{
    ...
    $payment= Payment::setConfig($config);  //laravel/thinkphp框架下按文档说明把配置文件放入config文件夹下后，无需调用本函数，可直接使用Payment::alipayTradePrecreate()
    $payment=$payment->alipayTradePrecreate($no,$amount,$subject);
